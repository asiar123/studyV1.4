...
class History(models.Model):
	...
	History6 = models.CharField(max_length=100, null=True)
	History7 = models.CharField(max_length=100, null=True)
	History8 = models.CharField(max_length=100, null=True)
